...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, PurchasedProduct> purchasedProductProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PurchasedProduct> purchasedProductKafkaTemplate() {
        return new KafkaTemplate<>(purchasedProductProducerFactory());
    }
}
